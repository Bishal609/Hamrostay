...
export const vendorApi = {
  ...
  updateMyProfile:     (data)                 => axiosInstance.put("/vendors/me", data),
  ...
  getMyInventory:      ()                     => axiosInstance.get("/vendors/me/inventory"),
  addInventoryItem:    (vendorId, data)        => axiosInstance.post(`/vendors/${vendorId}/inventory`, data),
  addMyInventoryItem:  (data)                 => axiosInstance.post("/vendors/me/inventory", data),
  updateInventoryItem: (vendorId, itemId, data)=> axiosInstance.put(`/vendors/${vendorId}/inventory/${itemId}`, data),
  updateMyInventoryItem:(itemId, data)        => axiosInstance.put(`/vendors/me/inventory/${itemId}`, data),
