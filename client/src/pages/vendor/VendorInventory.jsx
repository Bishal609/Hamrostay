...
export default function VendorInventory() {
  ...
  const { data: inventory, isLoading } = useQuery({
    ...
    queryFn: () => vendorApi.getMyInventory().then(r => r.data.data),
    enabled: !!profile,
  });

  const addMutation = useMutation({
    mutationFn: (data) => vendorApi.addMyInventoryItem(data),
  ...
  const updateMutation = useMutation({
    mutationFn: ({ itemId, data }) => vendorApi.updateMyInventoryItem(itemId, data),
