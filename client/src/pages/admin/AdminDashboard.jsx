...
import { IndianRupee, BedDouble, BookOpen, Users, TrendingUp, Clock } from "lucide-react";
  ...
  return (
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="grid grid-cols-2 xl:grid-cols-4 gap-4">
        <StatsCard title="Monthly Revenue"   value={kpi.revenue?.current?.toFixed(0) || 0} icon={IndianRupee} prefix="रू" change={kpi.revenue?.growth} changeLabel="vs last month" color="gold" />
      ...
      <div className="grid grid-cols-2 xl:grid-cols-4 gap-4">
        {[
          ...
          { label: "Net Profit",       value: `रू ${(kpi.netProfit || 0).toFixed(0)}`,icon: IndianRupee,  color: "text-gold-400",   bg: "bg-gold-500/10" },
      ...
      <div className="grid lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 card p-6">
          <div className="flex items-center justify-between mb-6">
            ...
            <Link to="/admin/fnmis" className="text-gold-400 text-xs hover:text-gold-300">View Full Report â†’</Link>
          </div>
          {chartData.length > 0 ? (
      ...
      <div className="card overflow-hidden">
        <div className="flex items-center justify-between p-6 border-b border-white/5">
          ...
          <Link to="/admin/bookings" className="text-gold-400 text-xs hover:text-gold-300">View all â†’</Link>
        </div>
