...
router.put("/me", authorize("VENDOR"), v.updateMyVendorProfile);
router.get("/me/inventory", authorize("VENDOR"), v.getMyInventory);
router.post("/me/inventory", authorize("VENDOR"), v.addMyInventoryItem);
router.put("/me/inventory/:itemId", authorize("VENDOR"), v.updateMyInventoryItem);
